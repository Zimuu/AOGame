...
public class Labyrinth extends BasicGameState {
	...
	public Labyrinth(GameState state) {
		this.state = state;
	}
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		tileMap = new TiledMap("resource/map/labyrinth.tmx");
	...
	private void enterState(StateBasedGame sbg) {
		if (mc.enterState(GameState.START_VILLAGE))
			sbg.enterState(GameState.START_VILLAGE.ordinal());
	}
